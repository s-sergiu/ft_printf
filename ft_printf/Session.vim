...
set laststatus=2
set modelines=1
set runtimepath=~/.vim,~/.vim/plugged/gruvbox,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=4
set showmatch
set smartcase
set smartindent
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 47 + 159) / 318)
exe '2resize ' . ((&lines * 38 + 39) / 79)
exe 'vert 2resize ' . ((&columns * 135 + 159) / 318)
exe '3resize ' . ((&lines * 38 + 39) / 79)
exe 'vert 3resize ' . ((&columns * 135 + 159) / 318)
exe 'vert 4resize ' . ((&columns * 134 + 159) / 318)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
1
normal! 0
lcd ~/Projects/ft_printf
wincmd w
argglobal
terminal ++curwin ++cols=135 ++rows=38 
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
wincmd w
argglobal
if bufexists("~/Projects/ft_printf/test.c") | buffer ~/Projects/ft_printf/test.c | else | edit ~/Projects/ft_printf/test.c | endif
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
wincmd w
argglobal
if bufexists("~/Projects/ft_printf/ft_printf.c") | buffer ~/Projects/ft_printf/ft_printf.c | else | edit ~/Projects/ft_printf/ft_printf.c | endif
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
exe 'vert 4resize ' . ((&columns * 134 + 159) / 318)
tabnext 1
badd +1 ~/Projects/ft_printf/ft_printf.c
badd +0 ~/Projects/ft_printf/test.c
